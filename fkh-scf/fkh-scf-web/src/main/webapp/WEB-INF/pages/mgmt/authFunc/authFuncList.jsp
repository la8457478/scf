...
<div id="heightPage" style="border: none; background: none;overflow-y: auto;overflow-x: hidden;">
    <div class="publicNavMain projectMgmtForm">
        <form action="authRole/listPage.json" name="reviewInvoiceForm" onsubmit="return searchReviewInvoices();" autocomplete="off">
            <input id="funcName" name="funcName" class="newPublicInput publicSwitchPlanProject" type="text" placeholder="请输入权限名称" style="width: 20%;">
            <input type="hidden" id="pageNo" name="pageNo" value="1">
            <input type="hidden" id="funcType" name="funcType" value="2">
            ...
            <div class="newPublicCustomGoodsBtn" onclick="editRole('','')"><img src="newassets/imgs/icon_new_add.png"><a>新增权限</a></div>
        </form>
    </div>
    <!--公用导航模块end-->
    <!--公用表格模块-->
    <div class="newPublicTable">
        <table>
            ...
            <tbody>
            <tr>
                <th class="newPublicTableCenter">权限名称</th>
...
<div class="publicContainerShow batchRecheckShowContainer configOilCompany" style="display:none;overflow: hidden;">
    <div class="remarksContainer newRemarksContainer">
        <form id="funcForm" name="funcForm">
            ...
            <input type="hidden" name="funcType" value="2">
            <div class="configOil">
                <span>权限名称:</span>
                <span>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        //回显条件
        Page.initFormData(document.reviewInvoiceForm);
    ...
    function parseInvoiceObjToHtml(resp) {
        ...
        if (responseData.records.length <= 0) {
            html = "<tr><td colspan='2' align='center'>暂无数据！</td></tr>";
    ...
    function deleteRole(funcId) {
        selfConfirm("你确定要删除该权限吗!",function () {
