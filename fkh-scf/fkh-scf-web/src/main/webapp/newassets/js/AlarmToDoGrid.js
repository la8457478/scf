...
{
    var url = globalConfig.webPath+'/data/msgTodoReqList.json';
    ...
    this.alarmToDoGrid.datagrid({
                columns: [[
                    ...
                    { title: '处理', field: 'result', width: 90,minWidth:80 },
...
{
	var alarmToDoId = rowData.id;
	
    var url = globalConfig.webPath+"/command/warnMsgTodo.action?msgId="+alarmToDoId;
