...
(function() {
     ...
     * lushu.start();
     */
    LuShu.prototype.start = function(arrPoints, finishCallback) {
        var me = this,
            len = me._path.length;
        ...
        if (me.i && me.i < len - 1) {
            ...
            if(arrPoints && typeof(arrPoints) == "object"){
                this._path = arrPoints;
            }
            ...
            finishCallback = typeof(arrPoints) == "function" ? arrPoints : finishCallback;
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        setRotation : function(prePos,curPos,targetPos){
            ...
            var t = targetPos;
            //改善百度默认实现的车辆方向抖动问题
            var newAngle = convertToBaidu(getAngle(c, t));

            /**
             *  屏蔽默认的实现方法，因为有方向抖动问题
             *  remove by liaohong on 2017-09-05
            ...
            if(targetPos.x != curPos.x){
                ...
                angle = parseFloat(-deg).toFixed(2);
            }else {
            ...
            */
            ...
            //console.log("1："+angle+",new:"+newAngle);
            me._marker.setRotation(newAngle);
            return;
        },
        ...
        _moveNext: function(index) {
            ...
            if (index < this._path.length - 1) {
                //addLabel(index+1, me._path[index].lng, me._path[index].lat);
                me._move(me._path[index], me._path[index + 1], me._tween.linear);
            }else{
                if(me.finishCallback){
                    me.finishCallback(this._path);
                }
                me.isFinish = true;
                // var line = new BMap.Polyline(me._path, {strokeColor: 'blue', strokeWeight: 3});
                // me.line = line;
                // me._map.addOverlay(line); //绘制地图线路
            }
        },
        /**
    ...
    CustomOverlay.prototype.initialize = function(map) {
        var div = this._div = baidu.dom.create('div', {style: 'border:solid 1px #BBDDFF;width:auto;min-width:50px;text-align:center;position:absolute;background:#2CC0E8;color:#FFFFFF;font-size:12px;border-radius: 5px;padding:5px;white-space: nowrap;'});
    ...
    baidu.object.extend(CustomOverlay.prototype, {
        ...
        setPosition: function(poi,markerSize) {
            ...
            this._div.style.bottom = -(px.y - markerSize.height + 85) + 'px';
        },
        //设置overlay的内容
