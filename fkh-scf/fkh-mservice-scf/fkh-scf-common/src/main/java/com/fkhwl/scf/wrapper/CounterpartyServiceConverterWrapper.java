 ...
 */
@Mapper
public interface CounterpartyServiceConverterWrapper extends ServiceConverterWrapper<CounterpartyDTO, Counterparty> {

    CounterpartyServiceConverterWrapper INSTANCE = Mappers.getMapper(CounterpartyServiceConverterWrapper.class);
}
