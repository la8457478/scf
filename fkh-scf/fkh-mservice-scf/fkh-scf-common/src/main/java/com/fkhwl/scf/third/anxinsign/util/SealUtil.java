package com.fkhwl.scf.third.anxinsign.util;
...
public class SealUtil {
    ...
    public static byte[] getSquarePng(String message,  int type) throws Exception {
        ...
        if (message != null) {
            ...
            buffImg = g2.getDeviceConfiguration().createCompatibleImage(255, 255, Transparency.TRANSLUCENT);
            ...
            if (type == 0) {
                // 竖向
                g2.drawString(new String(new char[] { charArray[0] }), fontSize+5, fontSize - fontSize / 8);
                g2.drawString(new String(new char[] { charArray[1] }), fontSize+5, fontSize * 2 - fontSize / 8);
                g2.drawString(new String(new char[] { charArray[2] }), 10, fontSize - fontSize / 8);
                g2.drawString(new String(new char[] { charArray[3] }), 10, fontSize * 2 - fontSize / 8);
            } else {
                // 横向
    ...
    public static final int CENTERX = 226;
    public static final int CENTERY = 226;

    public static byte[] getCirclePng_2(String message) throws Exception {
        BufferedImage buffImg = new BufferedImage(CENTERX * 2, CENTERY * 2, BufferedImage.TYPE_INT_RGB);
        Graphics2D g2 = buffImg.createGraphics();
        //填充整个屏幕
        ...
        //绘制中间的五角星
        Font starFont = new Font("宋体", Font.BOLD, 150);
        g2.setFont(starFont);
        g2.drawString("★", CENTERX - 74, CENTERY + 40);
        ...
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        ImageIO.write(buffImg, "png", byteArrayOutputStream);
        return ImageUtil.resizeImage(byteArrayOutputStream.toByteArray(), CENTERX*2, CENTERY*2);
    }
