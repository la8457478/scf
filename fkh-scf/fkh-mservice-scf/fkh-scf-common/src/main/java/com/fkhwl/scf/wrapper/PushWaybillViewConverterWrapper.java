 ...
 */
@Mapper
public interface PushWaybillViewConverterWrapper extends ViewConverterWrapper<WaybillVO, WaybillDTO> {

    /**
     * The constant INSTANCE.
     */
    PushWaybillViewConverterWrapper INSTANCE = Mappers.getMapper(PushWaybillViewConverterWrapper.class);

    /**
     * form转dto
     *
     * @param pushWaybillForm form
     * @return dto
     */
    PushWaybillDTO dto(PushWaybillForm pushWaybillForm);
}
