...
public class CounterpartyForm extends BaseForm<Long> {
    ...
    @Builder.Default
    private BigDecimal subitemLimitBalance = BigDecimal.ZERO;
    @ApiModelProperty(value = "规定比例")
    @Builder.Default
    private BigDecimal ruleRatio = BigDecimal.ZERO;
    @ApiModelProperty(value = "分项已使用额")
    @Builder.Default
    private BigDecimal subitemUsedBalance = BigDecimal.ZERO;
    @ApiModelProperty(value = "分项剩余限额")
    @Builder.Default
    ...
    @Builder.Default
    private BigDecimal hadReceivableBalance = BigDecimal.ZERO;
    @ApiModelProperty(value = "累计放款额：计算得出")
    @Builder.Default
    private BigDecimal totalLendingBalance = BigDecimal.ZERO;
